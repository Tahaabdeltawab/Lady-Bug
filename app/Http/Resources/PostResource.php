...
class PostResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $return = [
            ...
            'likers' => UserResource::collection($post->likers), //$post->when( auth()->id() == $post->author_id ,UserResource::collection($post->likers)), //[],
            'dislikers' => UserResource::collection($post->dislikers), //$post->when( auth()->id() == $post->author_id ,UserResource::collection($post->dislikers)), //[],
