...
class CreateFarmsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('farms', function (Blueprint $table) {
            ...
            $table->double('home_plant_pot_size');
            $table->double('area');
            $table->bigInteger('farmed_number');
            $table->foreignId('area_unit_id')->constrained('measuring_units');
            ...
            $table->foreignId('animal_breeding_purpose_id')->constrained();
            $table->foreignId('home_plant_illuminating_source_id')->constrained();
            $table->foreignId('farming_method_id')->constrained();
            $table->foreignId('farming_way_id')->constrained();
            $table->foreignId('irrigation_way_id')->constrained();
            $table->foreignId('soil_type_id')->constrained();
            $table->foreignId('soil_detail_id')->constrained('chemical_details');
            $table->foreignId('irrigation_water_detail_id')->constrained('chemical_details');
            $table->foreignId('animal_drink_water_salt_detail_id')->constrained('salt_details');
            $table->timestamps();
            $table->softDeletes();
